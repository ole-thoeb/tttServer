...
sealed class TTTGameRequest {

    abstract val gameId: GameId
    abstract val playerId: PlayerId

    @Serializable
    data class SetPiece(val content: Content) : TTTGameRequest() {
        ...
        companion object : JsonTypeDeserializer<SetPiece, Content> {
            override val typeConstructor: (Content) -> SetPiece = TTTGameRequest::SetPiece
